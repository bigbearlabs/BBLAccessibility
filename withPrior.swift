...
extension Publisher {
    ...
    func withPrior() -> AnyPublisher<(previous: Output?, current: Output), Failure> {
    ...
    /// - Returns: A publisher of a tuple of the previous and current elements from the upstream publisher.
    func withPrior(_ initialPreviousValue: Output) -> AnyPublisher<(previous: Output, current: Output), Failure> {
